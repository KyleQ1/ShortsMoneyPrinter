...
export const modelInfo: Record<Quality, ModelInfo> = {
  budget: {
    ...
    detail:
      "API key required. 480p image-to-video from a keyframe. It does not take direct video input, so source motion may be less faithful.",
    cost: "$0.013/sec without generated audio. Around $0.13 for 10s or $0.39 for 30s.",
  },
  standard: {
    title: "Replicate Seedance 2.0 Fast",
    detail:
      "API key required. 480p video-to-video. Default for faithful source motion and fastest paid cloud mode.",
    cost: "$0.08/sec using Replicate's video-input tier. Around $0.80 for 10s or $2.40 for 30s.",
  },
  premium: {
    title: "Replicate Seedance 2.0",
    detail:
      "API key required. 720p video-to-video. Highest cloud quality and most expensive option.",
